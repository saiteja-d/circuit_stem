...
import 'package:stemcir/screens/level_selection_screen.dart';
  ...
  void _showAbout(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('About StemCir'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
              'StemCir is an educational circuit simulation game designed to teach basic electronics and circuit building principles.',
